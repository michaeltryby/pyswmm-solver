...
int EXPORT_OUT_API SMO_getDateSeries(SMO_Handle p_handle, int startPeriod, int endPeriod, double **double_out, int *int_dim);
void EXPORT_OUT_API SMO_decodeDate(double date, int *year, int *month, int *day, int *hour, int *minute, int *second, int *dayOfWeek);
